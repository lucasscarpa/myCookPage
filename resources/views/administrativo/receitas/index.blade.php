...
<div class="row">
	<div class="col-lg-12">
		<div class="main-box">
			<header>
				<h2 class="pull-left">Receitas ({{($receitas->count())}})</h2>
				<div class="filter-block pull-right">
					<a href="{{ route('dashboard.administrativo.receita.form') }}" class="btn btn-success pull-right">
				...
				<div class="table-responsive">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="{{route('dashboard.administrativo.receita.form', $receita->id)}}" class="table-link">
									<span class="fa-stack">
